...
l6="6-0e 6-1f 6-2fs 6-3g 6-4gs 6-5a 1-0e 1-1f"
...
l1a="1-0e 1-1f 1-2fs 1-3g 1-4gs 1-5a 1-6as 1-7b 1-8c 1-9cs 1-10d"
l1b="1-11ds 1-12e 1-13f 1-14fs 1-15g 1-16gs 1-17a 1-18as"

for name in $l6 $l5 $l4 $l3 $l2 $l1a $l1b; do
  if ! [ -a $name.s16 ]; then
